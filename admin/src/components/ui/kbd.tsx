  ...
  return (
    <kbd
      className={cn(
        ...
        size === 'sm' && 'h-5 min-w-5 px-1 text-[10px] border-border bg-muted/50 text-muted-foreground',
        size === 'md' && 'h-6 min-w-6 px-1.5 text-[11px] border-border bg-muted text-muted-foreground',
        className
      )}
    >
      {children}
