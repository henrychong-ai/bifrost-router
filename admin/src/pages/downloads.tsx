  ...
  if (error) {
    return (
      <div className="space-y-6">
        <h1 className="text-huge font-inter font-bold text-blue-950">Downloads</h1>
        <Card className="border-destructive">
          <CardContent className="pt-6">
            <p className="text-destructive font-inter">Failed to load downloads: {error.message}</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-border/50">
        <CardHeader>
          <CardTitle className="font-inter font-semibold text-blue-950">Download Log</CardTitle>
                      ...
                      <TableRow key={download.id} className="hover:bg-gold-50/50 transition-colors">
                        ...
                        <TableCell className="text-small whitespace-nowrap">
                          {download.cacheStatus === 'HIT' ? (
                            <Badge
                              variant="default"
                              className="bg-emerald-500 hover:bg-emerald-600 text-white font-inter"
                            >
                              HIT
                            </Badge>
                            ...
                            <Badge
                              variant="default"
                              className="bg-amber-500 hover:bg-amber-600 text-white font-inter"
                            >
                              MISS
                            </Badge>
                          ) : (
